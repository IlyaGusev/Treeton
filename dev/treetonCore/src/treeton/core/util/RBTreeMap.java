 ...
 *
 *  $Id: RBTreeMap.java,v 1.13 2001/05/11 14:26:51 cursu Exp $
 */
...
public class RBTreeMap extends AbstractMap
     ...
     */
        ...
        if (it != null) {
            ...
            if (str != null) {
                ...
                key = ((java.util.Iterator) defaultVal).next();
                value = key;
            }
        }
    ...
    public Object getPreviousOf(Object key) {
        if (root == null) return null;
        Entry glb = getPrecedingEntry(key);
        if (glb == null) return null;
        return glb.value;
    }

    public Object getPreviousOrEqualOf(Object key) {
        if (root == null) return null;
        Entry glb = getPrecedingOrEqualEntry(key);
        if (glb == null) return null;
        return glb.value;
    }
    ...
    public void putAll(TreenotationStorage ts) {
        int ssize = ts.nTokens();
        if (size == 0 && ssize != 0) {
            ++modCount;
            try {
                buildFromSorted(ssize, null,
                        null, ts.tokenIterator());
            } catch (java.io.IOException cannotHappen) {
            } catch (ClassNotFoundException cannotHappen) {
            }
            return;
    ...
    private Entry getPrecedingOrEqualEntry(Object key) {
        Entry p = root;
        if (p == null) return null;
    ...
    private void deleteEntry(Entry p) {
        ...
        if (replacement != null) {
            ...
            // nu out links so they are OK to use by fixAfterDeletion.
