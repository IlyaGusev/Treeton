...
package treeton.gui.trnrelstable; // в оригинале sun.swing.table
...
/**
 * Класс из rt.jar из JRE. В JDK его нет. Используется для создания собственных рисовалок заголовка таблицы.
 */
